      ...
      <div className="container mx-auto">
        ...
        <div className="-mx-4 flex flex-wrap">
          <PricingCard
            ...
            price="$19"
            subscription="month"
            description="Perfect for starting your business"
            buttonText="Get Started"
          >
            <List>1 Website</List>
            <List>5 GB Hosting</List>
          ...
          <PricingCard
            ...
            active={true}
          >
            <List>5 Websites</List>
            <List>10 GB Hosting</List>
            <List>24/7 Support</List>
          </PricingCard>
          <PricingCard
            type="Premium"
            price="$99"
            subscription="month"
            description="Perfect for scaling your business"
            buttonText="Get Started"
          >
            <List>10 Websites</List>
            <List>20 GB Hosting</List>
            <List>24/7 Support</List>
          </PricingCard>
        </div>
      </div>
